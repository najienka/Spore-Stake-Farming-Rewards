...
contract SporeLoot is ERC20, AccessControl {
    
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    
    constructor() ERC20("Spore Loot Token", "sporeLOOT") {
...
contract SporeStake is IERC900, IERC2917, AccessControl, ReentrancyGuard, Pausable {
    ...
    constructor(SporeLoot _SPORE, uint256 _reward) {
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
